...
package body UmwandlungssystemHTSEB is
   ...
   is begin
      ...
      case
        UmwandlungsvariablenHTSEB.TrennzeichenAbfragen
      is
      ...
      for ZahlenSchleifenwert in Zwischenspeicher'Range loop
         ...
         is
            when Standardtrennzeichen =>
               Zwischenspeicher (ZahlenSchleifenwert) := UmwandlungsvariablenHTSEB.TrennzeichenAbfragen;
               exit ZahlenSchleife;
   ...
   is begin
      ...
      case
        UmwandlungsvariablenHTSEB.KodierungAbfragen
      is
