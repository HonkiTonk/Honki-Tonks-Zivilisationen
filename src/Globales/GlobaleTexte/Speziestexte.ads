...
package Speziestexte is
   ...
   type NameBeschreibungArray is array (SpeziesDatentypen.Spezies_Verwendet_Enum'Range, TextnummernKonstanten.Beschreibungen'Range) of Unbounded_Wide_Wide_String;
   ...
   type ForschungenArray is array (SpeziesDatentypen.Spezies_Verwendet_Enum'Range, ForschungenDatentypen.ForschungID'Range, TextnummernKonstanten.Beschreibungen'Range) of Unbounded_Wide_Wide_String;
   ...
   type GebäudeArray is array (SpeziesDatentypen.Spezies_Verwendet_Enum'Range, StadtDatentypen.GebäudeID'Range, TextnummernKonstanten.Beschreibungen'Range) of Unbounded_Wide_Wide_String;
