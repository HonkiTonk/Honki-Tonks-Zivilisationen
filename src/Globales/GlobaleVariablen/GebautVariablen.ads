...
package GebautVariablen is
   ...
   type StadtGebautArray is array (SpeziesDatentypen.Spezies_Verwendet_Enum'Range, StadtDatentypen.StädtebereichVorhanden'Range) of StadtRecords.StadtGebautRecord;
