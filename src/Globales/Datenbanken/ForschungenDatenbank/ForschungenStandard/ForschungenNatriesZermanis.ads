...
package ForschungenNatriesZermanis is
   pragma Elaborate_Body;

   ForschungslisteNatriesZermanis : constant ForschungsdatenbankRecord.ForschungslisteArray := (
                                                                                                -- Steinwerkzeuge
                                                                                                1 =>
                                                                                                  (
                                                                                                   Kosten      => 100,
...
end ForschungenNatriesZermanis;
