...
package GebaeudedatenbankRecord is
   ...
   type BasisgrundArray is array (KartenbasisgrundDatentypen.Basisgrund_Vorhanden_Enum'Range) of Boolean;
   type ZusatzgrundArray is array (KartenzusatzgrundDatentypen.Zusatzgrund_Vorhanden_Enum'Range) of Boolean;
