...
package GrafikRecordKonstanten is
   ...
   Steuerungbereich : constant BereicheArray (Views.SteuerungviewAccesse'Range) := (
                                                                                    ...
                                                                                    ViewKonstanten.SteuerungVollauswahl  => (0.00, Überschriftbereich.height + 0.05, 1.00, 1.00 - Überschriftbereich.height - 0.05),
                                                                                    ViewKonstanten.SteuerungTeilauswahl  => (0.00, Überschriftbereich.height + 0.05, 0.98, 1.00 - Überschriftbereich.height - 0.05),
