...
package KartenKonstanten is
   ...
   LeerWeltkarte : constant KartenRecords.KartenRecord := (
                                                           Grund                   => KartenDatentypen.Leer_Grund,
                                                           Hügel                   => LeerHügel,
                                                           Sichtbar                => (others => LeerSichtbar),
                                                           Fluss                   => KartenDatentypen.Leer_Grund,
                                                           VerbesserungWeg         => KartenDatentypen.Leer_Verbesserung,
                                                           VerbesserungGebiet      => KartenDatentypen.Leer_Verbesserung,
                                                           Ressource               => KartenDatentypen.Leer_Grund,
