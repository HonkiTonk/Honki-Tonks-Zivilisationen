...
package SystemKonstanten is
   ...
   -- Für die Auswahl
   LeerRückgabeKonstante : constant SystemDatentypen.Rückgabe_Werte_Enum := SystemDatentypen.Leer_Rückgabe;
   ...
   -- Für Spielerbelegung
   LeerSpielerKonstante : constant SystemDatentypen.Spieler_Enum := SystemDatentypen.Leer_Spieler;
   SpielerMenschKonstante : constant SystemDatentypen.Spieler_Enum := SystemDatentypen.Spieler_Mensch;
   SpielerKIKonstante : constant SystemDatentypen.Spieler_Enum := SystemDatentypen.Spieler_KI;
   -- Für Spielerbelegung
