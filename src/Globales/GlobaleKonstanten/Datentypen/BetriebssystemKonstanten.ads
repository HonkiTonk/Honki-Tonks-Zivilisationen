...
package BetriebssystemKonstanten is
   ...
   -- Allgemein
   type VerboteneNamenArray is array (1 .. 2) of Unbounded_Wide_Wide_String;
   VerboteneName : constant VerboteneNamenArray := (
   ...
   -- Windows
   type VerboteneWindowsnamenArray is array (1 .. 25) of Unbounded_Wide_Wide_String;
   VerboteneWindowsnamenGroß : constant VerboteneWindowsnamenArray := (
   ...
   VerboteneWindowsnamenKlein : constant VerboteneWindowsnamenArray := (
                                                                        1 => To_Unbounded_Wide_Wide_String (Source => "aux"),
                                                                        2 => To_Unbounded_Wide_Wide_String (Source => "clock$"),
                                                                        3 => To_Unbounded_Wide_Wide_String (Source => "con"),
                                                                        4 => To_Unbounded_Wide_Wide_String (Source => "prn"),
