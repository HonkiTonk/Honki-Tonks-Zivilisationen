package MenueDatentypen is
   ...
   type Welches_Menü_Enum is (
                               ...
                               -- Mit Überschrift.
                               Optionen_Menü_Enum, Grafik_Menü_Enum, Sound_Menü_Enum, Spieleinstellungen_Menü_Enum, Editoren_Menü_Enum, Sonstige_Einstellungen_Menü_Enum, Debug_Menü_Enum,
                               Kartenart_Menü_Enum, Kartenressourcen_Menü_Enum, Schwierigkeitsgrad_Menü_Enum, Kartentemperatur_Menü_Enum, Kartengröße_Menü_Enum, Kartenebene_Menü_Enum, Diplomatie_Menü_Enum,
                               Handel_Menü_Enum, Kartenpole_Menü_Enum,
