...
package KartenGrundDatentypen is
   ...
   subtype Karten_Fluss_Enum is Karten_Grund_Vorhanden_Enum range Flusskreuzung_Vier_Enum .. Karten_Grund_Vorhanden_Enum'Last;
   ...
   subtype Karten_Grund_Ressourcen_Enum is Karten_Grund_Vorhanden_Enum range Fisch_Enum .. Gold_Enum;
   subtype Karten_Grund_Ressourcen_Wasser is Karten_Grund_Ressourcen_Enum range Karten_Grund_Ressourcen_Enum'First .. Wal_Enum;
   subtype Karten_Grund_Ressourcen_Land is Karten_Grund_Ressourcen_Enum range Kohle_Enum .. Karten_Grund_Ressourcen_Enum'Last;
   ...
   subtype Karten_Grund_Fluss_Enum is Karten_Fluss_Enum range Flusskreuzung_Vier_Enum .. See_Enum;
   subtype Karten_Grund_Unterirdischer_Fluss_Enum is Karten_Fluss_Enum range Unterirdische_Flusskreuzung_Vier_Enum .. Unterirdischer_See_Enum;
   subtype Karten_Grund_Lavafluss_Enum is Karten_Fluss_Enum range Lavaflusskreuzung_Vier_Enum .. Lavasee_Enum;
