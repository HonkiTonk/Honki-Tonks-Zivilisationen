package GrafikDatentypen is
   ...
   type Aktuelle_Anzeige_Enum is (
                                  ...
                                  Generierungszeit_Enum, KI_Rechenzeit_Enum, Rundenende_Enum,
                                  Speichern_Enum, Prüfen_Enum, Laden_Enum,
   ...
   subtype Spielstand_Enum is Ladezeiten_Enum range Speichern_Enum .. Ladezeiten_Enum'Last;
