with Ada.Wide_Wide_Text_IO, Ada.Strings.Wide_Wide_Unbounded, Anzeige, GlobaleDatentypen, GlobaleVariablen, KartenDatenbank, Karten, Eingabe, SchleifenPruefungen;
