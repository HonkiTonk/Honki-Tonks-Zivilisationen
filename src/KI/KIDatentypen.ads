...
package KIDatentypen is
   ...
   type Einheit_Befehl_Ermitteln_Enum is (Keine_Aufgabe, Stadt_Bauen, Einheit_Bewegen, Verbesserung_Anlegen, Einheit_Auflösen, Fliehen, Einheit_Festsetzen, Einheit_Verbessern);
