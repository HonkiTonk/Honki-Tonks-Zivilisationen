...
package InteraktionAuswahl is
   ...
   -- Muss nicht identisch mit dem längsten Menü sein, sondern immer nur der Länge der maximalen Auswahlmöglichkeiten entsprechen. äöü
   -- Aktuell sollte dass die Rassenauswahl sein. Eventuell mal anpassen oder ein besseres System finden. äöü
