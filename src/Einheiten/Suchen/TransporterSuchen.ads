...
with GlobaleVariablen, KartenRecords, EinheitStadtRecords, SonstigeDatentypen, EinheitStadtDatentypen, KartenDatentypen;
use KartenRecords, SonstigeDatentypen, KartenDatentypen, EinheitStadtDatentypen;
