...
package body CursorAltPlatzieren is
   ...
   is begin
      ...
      if
        SpielVariablen.CursorImSpiel (RasseExtern).KoordinatenAlt.YAchse + Sichtweiten.BewegungsfeldLesen (YAchseXAchseExtern => True) > Karten.Kartengrößen (Karten.Kartenparameter.Kartengröße).YAchse
      then
         if
   ...
   is begin
      ...
      if
        SpielVariablen.CursorImSpiel (RasseExtern).KoordinatenAlt.XAchse + Sichtweiten.BewegungsfeldLesen (YAchseXAchseExtern => False) > Karten.Kartengrößen (Karten.Kartenparameter.Kartengröße).XAchse
      then
         if
