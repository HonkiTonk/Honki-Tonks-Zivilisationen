   ...
   is begin
      ...
      is
         when True =>
            ...
            if
              RasseUndPlatznummer.Platznummer = GlobaleKonstanten.RückgabeEinheitStadtNummerFalsch
            then
               null;
               ...
               is
                  ...
                  when True =>
                     Cheat.KarteInfosEinheiten (EinheitRasseNummerExtern => RasseUndPlatznummer);                     
               end case;
            end if;
