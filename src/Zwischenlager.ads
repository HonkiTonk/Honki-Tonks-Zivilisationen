...
-- Das hier erst einmal noch eine Weile behalten, eventuell habe ich beim zerlegen/aufteilen ja etwas vergessen!
         ...
         when True =>
            ...
            loop
               ...
               then
                  ...
                  then
                     case
                       TransporterBeladenEntladenLogik.TransporterBeladen (TransporterExtern => AndereEinheit,
                     ...
                     is
                        ...
                        when False =>
                           BewegungsberechnungEinheitenLogik.Bewegungsberechnung (EinheitSpeziesNummerExtern => AndereEinheit,
