...
package body EinheitenErzeugenEntfernenLogik is
   ...
   is begin
      ...
      Diagnoseinformationen.Einheiteninformationen (EinheitSpeziesNummerExtern => EinheitSpeziesNummerExtern);
      Diagnoseinformationen.Zahl (ZahlExtern => Integer (LeseWichtiges.AnzahlSonstiges (SpeziesExtern => EinheitSpeziesNummerExtern.Spezies)));
