package ChangelogVorlage is
   ...
   -- Version 0.05.1880 => 0.05.1910 (12..2023):
   
   -- GNAT-12 auf GNAT-13 aktualisiert und alle notwendigen Bibliotheken aktualisiert.
   -- Fehler in den gpr Dateien korrigiert.
   
   

   -- Version 0.05.1865 => 0.05.1880 (11.06.2023):
   ...
   -- Textanzeige überarbeitet, um bei kleineren Auflösung eine bessere Lesbarkeit zu erreichen.
