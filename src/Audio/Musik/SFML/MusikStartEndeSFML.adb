...
package body MusikStartEndeSFML is
   ...
   is begin
      ...
      if
        EingeleseneMusik.Musik (SystemDatentypen.Keine_Rasse_Enum, 1) = null
      then
         null;
         
      else
         Sf.Audio.Music.play (music => EingeleseneMusik.Musik (SystemDatentypen.Keine_Rasse_Enum, 1));
      end if;
   ...
   is begin
      ...
      then
         ...
         Sf.Audio.Music.stop (music => EingeleseneMusik.Musik (SystemDatentypen.Keine_Rasse_Enum, 1));
      end if;
   ...
   is begin
      ...
      Sf.Audio.Music.destroy (music => EingeleseneMusik.Musik (SystemDatentypen.Keine_Rasse_Enum, 1));
