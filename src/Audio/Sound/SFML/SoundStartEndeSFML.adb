...
package body SoundStartEndeSFML is
   ...
   is begin
      ...
      if
        EingeleseneSounds.Sound (RueckgabeDatentypen.Keine_Rasse_Enum, 1) = null
      then
         null;
         
      else
         Sf.Audio.Sound.setBuffer (sound  => SoundTest,
                                   buffer => EingeleseneSounds.Sound (RueckgabeDatentypen.Keine_Rasse_Enum, 1));
   ...
   is begin
      ...
      Sf.Audio.SoundBuffer.destroy (soundBuffer => EingeleseneSounds.Sound (RueckgabeDatentypen.Keine_Rasse_Enum, 1));
