   ...
   begin
      ...
      loop
         ...
         case WasGebautWerdenSoll is
            ...
            when 1_000 .. 99_999 => -- Gebäude - 1_000, Einheiten - 10_000
               GebaeudeDatenbank.ProduktionFestlegen (Rasse             => Rasse,
                                                      Stadtnummer       => StadtPositionInListe,
                                                      Produktionsnummer => WasGebautWerdenSoll);
