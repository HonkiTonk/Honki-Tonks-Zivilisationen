...
package EinheitenDatenbank is
   ...
   EinheitenListe : EinheitenListeArray := (
                                            GlobaleDatentypen.Rasse_1 =>
                                              (
                                               -- Siedler
                                               1 => ('S', GlobaleDatentypen.Unbewaffnet, 10, 10, 0,
                                                     (GlobaleDatentypen.Boden => True, others => False),
                                                     3, 3.00, 0,
                                                     30, 3, 1, 1, 1,
                                                     0, 1, 0),
                                               -- Steinbeilkämpfer
                                               2 => ('L', GlobaleDatentypen.Nahkämpfer, 25, 20, 0,
                                                     (GlobaleDatentypen.Boden => True, others => False),
                                                     5, 3.00, 0,
                                                     30, 3, 1, 3, 1,
                                                     0, 1, 0),
                                               -- Bogenschütze
                                               3 => ('L', GlobaleDatentypen.Fernkämpfer, 25, 20, 5,
                                                     (GlobaleDatentypen.Boden => True, others => False),
                                                     5, 3.00, 4,
                                                     30, 3, 1, 3, 1,
                                                     0, 1, 0),
                                               -- Kanone
                                               4 => ('L', GlobaleDatentypen.Fernkämpfer, 50, 5, 8,
                                                     (GlobaleDatentypen.Boden => True, others => False),
                                                     3, 3.00, 0,
                                                     30, 3, 3, 8, 1,
                                                     0, 2, 0),
                                               ...
                                               6 => ('S', GlobaleDatentypen.Fernkämpfer, 20, 10, 20,
                                                     ...
                                                     2, 0, 0),
                                               -- UBoot
                                               7 => ('U', GlobaleDatentypen.Nahkämpfer, 20, 10, 20,
                                               ...
                                               8 => ('F', GlobaleDatentypen.Nahkämpfer, 100, 10, 20,
                                                     ...
                                                     0, 1, 0),
                                               -- Bomber
                                               9 => ('F', GlobaleDatentypen.Fernkämpfer, 100, 10, 0,
                                                     (GlobaleDatentypen.Boden => True, GlobaleDatentypen.Wasser => True, GlobaleDatentypen.Luft => True, others => False),
                                                     8, 3.00, 0,
                                                     30, 3, 1, 10, 1,
                                                     2, 0, 0),
                                               -- Rakete
                                               10 => ('R', GlobaleDatentypen.Nahkämpfer, 20, 10, 20,
                                                      ...
                                                      0, 0, 0),
                                               -- Unterwasserrakete
                                               11 => ('R', GlobaleDatentypen.Nahkämpfer, 20, 10, 20,
                                                      (GlobaleDatentypen.Boden => True, GlobaleDatentypen.Wasser => True, GlobaleDatentypen.Luft => True, GlobaleDatentypen.Weltraum => True,
                                                      ...
                                                      0, 0, 0),
                                               -- Alleskönner
                                               12 => ('A', GlobaleDatentypen.Beides, 1, 1, 0,
                                                      (others => True),
                                                      100, 100.00, 0,
                                                      1, 1, 1, 1, 1,
                                                      10, 0, 10),
