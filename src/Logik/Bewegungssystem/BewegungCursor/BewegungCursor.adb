      ...
      is
         ...
         when True =>
            ...
            KoordinatenPunkt := Eingabe.GanzeZahl (ZeileExtern         => 30,
                                                   ...
                                                   ZahlenMaximumExtern => Positive (Karten.Kartengrößen (Karten.Kartenparameter.Kartengröße).YAchse));
      end case;
      ...
      is
         ...
         when True =>
            ...
            KoordinatenPunkt := Eingabe.GanzeZahl (ZeileExtern         => 31,
                                                   ...
                                                   ZahlenMaximumExtern => Positive (Karten.Kartengrößen (Karten.Kartenparameter.Kartengröße).XAchse));
      end case;
