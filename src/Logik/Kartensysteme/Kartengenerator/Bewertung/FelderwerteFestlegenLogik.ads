...
package FelderwerteFestlegenLogik is
...
private
   ...
   procedure BewertungSelbst
     ...
     with
       Pre => (
                 KoordinatenFeldExtern.YAchse <= Weltkarte.Karteneinstellungen.Kartengröße.YAchse
               and
                 KoordinatenFeldExtern.XAchse <= Weltkarte.Karteneinstellungen.Kartengröße.XAchse
               and
                 TeilerExtern > 0
              );
