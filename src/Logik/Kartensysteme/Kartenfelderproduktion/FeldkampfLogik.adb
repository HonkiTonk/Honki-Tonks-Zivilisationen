...
-- Hier als Grundwert die Standardwerte der Einheit nehmen und entsprechend damit weiterrechnen? Siehe dazu auch KampfwerteEinheitErmittelnLogik. äöü
-- Auch die Berücksichtigen dass die Städte wieder anders ihre Kampfwerte berechnen. Siehe dazu auch KampfwerteStadtErmittelnLogik. äöü
package body FeldkampfLogik is
