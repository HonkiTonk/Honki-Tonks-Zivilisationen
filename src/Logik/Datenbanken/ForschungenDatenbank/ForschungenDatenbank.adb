...
package body ForschungenDatenbank is
   ...
   is begin
      ...
      for VerbesserungSchleifenwert in ForschungKonstanten.TechnologieVerbesserungenArray'Range (1) loop
         ...
         TechnologieVerbesserungen (VerbesserungSchleifenwert, RasseExtern) := ForschungKonstanten.StandardtechnologieVerbesserungen (VerbesserungSchleifenwert, RasseExtern);
      ...
      for WegSchleifenwert in ForschungKonstanten.TechnologieWegeArray'Range (1) loop
         ...
         TechnologieWege (WegSchleifenwert, RasseExtern) := ForschungKonstanten.StandardtechnologieWege (WegSchleifenwert, RasseExtern);
      ...
      for UmgebungSchleifenwert in ForschungKonstanten.TechnologieUmgebungsgrößeArray'Range (1) loop
         ...
         TechnologieUmgebungsgröße (UmgebungSchleifenwert, RasseExtern) := ForschungKonstanten.StandardtechnologieUmgebungsgröße (UmgebungSchleifenwert, RasseExtern);
