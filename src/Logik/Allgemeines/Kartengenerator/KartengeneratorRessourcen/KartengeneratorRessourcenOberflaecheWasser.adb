...
package body KartengeneratorRessourcenOberflaecheWasser is
   ...
   end KartengeneratorRessourcenOberflächeWasser;
   ...
   is begin
      ...
      is
         ...
         when others =>
            Warnung.LogikWarnung (WarnmeldungExtern => "KartengeneratorRessourcenOberflaecheWasser.RessourceZusatzberechnungen - Ressourcenart passt nicht zum Grund.");
