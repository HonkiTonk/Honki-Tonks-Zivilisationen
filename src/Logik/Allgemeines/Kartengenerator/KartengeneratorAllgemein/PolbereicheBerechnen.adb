...
package body PolbereicheBerechnen is
   ...
   is begin
      ...
      KartengeneratorVariablen.SchleifenendeOhnePolbereich.YAchse := Karten.Kartengrößen (Karten.Kartenparameter.Kartengröße).YAchse - Karten.Polgrößen (KartenDatentypen.Süden_Enum);
      ...
      KartengeneratorVariablen.SchleifenendeOhnePolbereich.XAchse := Karten.Kartengrößen (Karten.Kartenparameter.Kartengröße).XAchse - Karten.Polgrößen (KartenDatentypen.Osten_Enum);
