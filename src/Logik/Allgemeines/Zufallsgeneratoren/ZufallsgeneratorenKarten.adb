...
package body ZufallsgeneratorenKarten is
   ...
   is begin
      ...
      is
         ...
         when RueckgabeDatentypen.Karte_Größe_80_80_Enum =>
         ...
         when RueckgabeDatentypen.Karte_Größe_320_320_Enum =>
         ...
         when RueckgabeDatentypen.Karte_Größe_1000_1000_Enum =>
