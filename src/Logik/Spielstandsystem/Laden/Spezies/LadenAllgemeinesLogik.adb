...
package body LadenAllgemeinesLogik is
   ...
   begin
      ...
      LadezeitenLogik.SpielstandSchreiben (BerechnungszeitExtern => LadezeitenDatentypen.Allgemeines_Enum,
                                           ZeitExtern            => SystemDatentypenHTSEB.LadezeitBasis'Last / 2.00);
